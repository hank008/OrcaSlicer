...
#define SLIC3R_APP_FULL_NAME "BSRC Slicer"
#define GCODEVIEWER_APP_NAME "BSRCSlicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "BSRCSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("BSRCSlicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
